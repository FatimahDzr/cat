#include "SinteringMobility1.h"
// libMesh includes
#include "libmesh/quadrature.h"

registerMooseObject("CrowApp", SinteringMobility1);
...
SinteringMobility1::SinteringMobility1(const InputParameters & parameters) :
    Material(parameters),
...
void
SinteringMobility1::computeProperties()
{
