#include "SinteringMobility3.h"
// libMesh includes
#include "libmesh/quadrature.h"

registerMooseObject("CrowApp", SinteringMobility3);

template<>
InputParameters validParams<SinteringMobility3>()
{
...
SinteringMobility3::SinteringMobility3(const InputParameters & parameters) :
    Material(parameters),
...
void
SinteringMobility3::computeProperties()
{
